...
<html>
<head>
    <title>Thêm hoặc chỉnh sửa sản phẩm</title>
</head>
<body>
<div class="container">
    ...
    <form:form method="post" action="${action}" modelAttribute="product" enctype="multipart/form-data">
        ...
        <div>
            <label for="imgId">Anh san pham</label>
            <form:input path="img" id="imgId" type="file" cssClass="form-control" name="attach"></form:input>
        </div>
        <div>
            <br>
